...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eece496_evaluation', 'volunteer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='volunteer_set', null=True, to=orm['eece496.Student']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.volunteer'
        db.delete_column('eece496_evaluation', 'volunteer_id')
    ...
    models = {
        ...
        'eece496.evaluation': {
            ...
            'volunteer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'volunteer_set'", 'null': 'True', 'to': "orm['eece496.Student']"})
        },
        'eece496.group': {
            'Meta': {'object_name': 'Group'},
