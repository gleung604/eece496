...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eece496_sessiontime', (
        ...
        db.send_create_signal('eece496', ['SessionTime'])


        # Renaming column for 'Session.time' to match new field type.
        db.rename_column('eece496_session', 'time', 'time_id')
        # Changing field 'Session.time'
        db.alter_column('eece496_session', 'time_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eece496.SessionTime']))
        # Adding index on 'Session', fields ['time']
        db.create_index('eece496_session', ['time_id'])


    def backwards(self, orm):
        # Removing index on 'Session', fields ['time']
        db.delete_index('eece496_session', ['time_id'])

        # Deleting model 'SessionTime'
        db.delete_table('eece496_sessiontime')


        # Renaming column for 'Session.time' to match new field type.
        db.rename_column('eece496_session', 'time_id', 'time')
        # Changing field 'Session.time'
        db.alter_column('eece496_session', 'time', self.gf('django.db.models.fields.CharField')(max_length=50))
