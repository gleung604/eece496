...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'COGS'
        db.create_table('eece496_cogs', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('eece496', ['COGS'])

        # Adding model 'Course'
        db.create_table('eece496_course', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('eece496', ['Course'])

        # Deleting field 'Session.time'
        db.delete_column('eece496_session', 'time')

        # Adding field 'Session.cogs'
        db.add_column('eece496_session', 'cogs',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['eece496.COGS']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'COGS'
        db.delete_table('eece496_cogs')

        # Deleting model 'Course'
        db.delete_table('eece496_course')
        ...
        # Deleting field 'Session.cogs'
        db.delete_column('eece496_session', 'cogs_id')
