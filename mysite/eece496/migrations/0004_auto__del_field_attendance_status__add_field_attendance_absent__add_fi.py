...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eece496_attendance', 'absent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Attendance.excused'
        db.add_column('eece496_attendance', 'excused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('eece496_attendance', 'absent')

        # Deleting field 'Attendance.excused'
        db.delete_column('eece496_attendance', 'excused')
