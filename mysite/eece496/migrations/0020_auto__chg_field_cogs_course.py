...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'COGS.course'
        db.alter_column('eece496_cogs', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eece496.Course'], null=True))

    def backwards(self, orm):

        # Changing field 'COGS.course'
        db.alter_column('eece496_cogs', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['eece496.Course']))
