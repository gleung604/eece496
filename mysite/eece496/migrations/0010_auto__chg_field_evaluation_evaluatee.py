...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('eece496_evaluation', 'evaluatee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eece496.Attendance']))

    def backwards(self, orm):

        # Changing field 'Evaluation.evaluatee'
        db.alter_column('eece496_evaluation', 'evaluatee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eece496.Student']))
    ...
    models = {
        ...
        'eece496.evaluation': {
            ...
            'evaluatee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evaluatee_set'", 'to': "orm['eece496.Attendance']"}),
