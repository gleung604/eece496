...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evaluation.evaluatee'
        db.alter_column('eece496_evaluation', 'evaluatee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eece496.Student']))

    def backwards(self, orm):
        # Adding field 'Evaluation.next_evaluation'
        db.add_column('eece496_evaluation', 'next_evaluation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eece496.Evaluation'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Evaluation.evaluatee'
        db.alter_column('eece496_evaluation', 'evaluatee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eece496.Attendance']))
