...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'COGS.date'
        db.alter_column('eece496_cogs', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'COGS.date'
        db.alter_column('eece496_cogs', 'date', self.gf('django.db.models.fields.CharField')(max_length=50))
