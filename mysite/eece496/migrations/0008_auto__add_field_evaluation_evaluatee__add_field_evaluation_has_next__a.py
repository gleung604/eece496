...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluation.evaluatee'
        db.add_column('eece496_evaluation', 'evaluatee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='evaluatee_set', to=orm['eece496.Student']),
                      keep_default=False)

        # Adding field 'Evaluation.has_next'
        db.add_column('eece496_evaluation', 'has_next',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Evaluation.next_evaluation'
        db.add_column('eece496_evaluation', 'next_evaluation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['eece496.Evaluation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.evaluatee'
        db.delete_column('eece496_evaluation', 'evaluatee_id')

        # Deleting field 'Evaluation.has_next'
        db.delete_column('eece496_evaluation', 'has_next')

        # Deleting field 'Evaluation.next_evaluation'
        db.delete_column('eece496_evaluation', 'next_evaluation_id')
    ...
    models = {
        ...
        'eece496.evaluation': {
            ...
            'evaluatee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evaluatee_set'", 'to': "orm['eece496.Student']"}),
            'has_next': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next_evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eece496.Evaluation']"}),
