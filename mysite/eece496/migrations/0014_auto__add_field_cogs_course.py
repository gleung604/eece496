...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'COGS.course'
        db.add_column('eece496_cogs', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['eece496.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'COGS.course'
        db.delete_column('eece496_cogs', 'course_id')
